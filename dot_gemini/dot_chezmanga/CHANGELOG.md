...
- Scope: `.`
- Summary: Added a dedicated marker and changelog for Gemini configuration.
- Important records:
  - The nearest ancestor marker owns future records; nested markers take precedence.
  - Authentication data, history, temporary files, and generated state remain excluded.
