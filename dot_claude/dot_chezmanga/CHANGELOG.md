...
- Scope: `.`
- Summary: Added a dedicated marker and changelog for Claude configuration.
- Important records:
  - The nearest ancestor marker owns future records; nested markers take precedence.
  - Runtime state, credentials, sessions, and caches remain excluded.
