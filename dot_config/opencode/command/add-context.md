...
Check: `$CONTEXT_DIR` (set in Stage 0.5 — either `/c/Users/tc_tseng/.config/opencode/context/project-intelligence/` or `~/.config/opencode/context/project-intelligence/`)
...
A: `cat /c/Users/tc_tseng/.config/opencode/context/project-intelligence/technical-domain.md` (local) or `cat ~/.config/opencode/context/project-intelligence/technical-domain.md` (global)
