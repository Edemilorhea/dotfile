...
/add-context --global        # Save to global config (C:/Users/tc_tseng/.config/opencode/) instead of project
```
...
**What happens**:
1. Saves to `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/` in your project (always local)
...
**Default behavior**: Always use local `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/`.
**Override**: `--global` flag saves to `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/` instead.

**Resolution:**
1. If `--global` flag → `$CONTEXT_DIR = C:/Users/tc_tseng/.config/opencode/context/project-intelligence/`
2. Otherwise → `$CONTEXT_DIR = C:/Users/tc_tseng/.config/opencode/context/project-intelligence/` (always local)

**If `C:/Users/tc_tseng/.config/opencode/context/` doesn't exist yet**, create it silently — no prompt needed. The directory structure is part of the output shown in Stage 4.
...
Check: `$CONTEXT_DIR` (set in Stage 0.5 — either `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/` or `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/`)
...
- Project Intelligence: C:/Users/tc_tseng/.config/opencode/context/core/standards/project-intelligence.md
- MVI Principles: C:/Users/tc_tseng/.config/opencode/context/core/context-system/standards/mvi.md
...
A: `cat C:/Users/tc_tseng/.config/opencode/context/project-intelligence/technical-domain.md` (local) or `cat C:/Users/tc_tseng/.config/opencode/context/project-intelligence/technical-domain.md` (global)

**Q: Multiple context files?**
A: Yes! Create in your project-intelligence directory. Agents load all.

**Q: Remove pattern?**
A: Edit directly: `nano C:/Users/tc_tseng/.config/opencode/context/project-intelligence/technical-domain.md`

**Q: Share w/ team?**
A: Yes! Use local install (`C:/Users/tc_tseng/.config/opencode/context/project-intelligence/`) and commit to repo. Team members get your patterns automatically.

**Q: Local vs global?**
A: Local (`.opencode/`) = project-specific, committed to git, team-shared. Global (`C:/Users/tc_tseng/.config/opencode/`) = personal defaults across all projects. Local overrides global.

**Q: Installed globally but want project patterns?**
A: Run `/add-context` (defaults to local). Creates `C:/Users/tc_tseng/.config/opencode/context/project-intelligence/` in your project even if OAC was installed globally.
