...
**`/context migrate`**
- Copy project-intelligence from global (`~/.config/opencode/context/`) to local (`/c/Users/tc_tseng/.config/opencode/context/`)
...
```bash
/context migrate
# Copies project-intelligence from ~/.config/opencode/context/ to /c/Users/tc_tseng/.config/opencode/context/
