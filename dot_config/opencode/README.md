...
- ✅ Flexible context discovery (.oac config, .claude/context, context, /c/Users/tc_tseng/.config/opencode/context)
...
**The OAC solution:** Store team patterns in `/c/Users/tc_tseng/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /c/Users/tc_tseng/.config/opencode/context/
...
Store patterns in `/c/Users/tc_tseng/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /c/Users/tc_tseng/.config/opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/c/Users/tc_tseng/.config/opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/c/Users/tc_tseng/.config/opencode/context/core/` | `/c/Users/tc_tseng/.config/opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/c/Users/tc_tseng/.config/opencode/context/project-intelligence/` |
| Both local and global | `/c/Users/tc_tseng/.config/opencode/context/core/` (local wins) | `/c/Users/tc_tseng/.config/opencode/context/project-intelligence/` |
...
A: Commit `/c/Users/tc_tseng/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
