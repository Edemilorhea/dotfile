...
├── .cache/
│   ├── test-coverage.md (cached from /c/Users/tc_tseng/.config/opencode/context/)
│   ├── code-quality.md
│   └── code-review.md
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/c/Users/tc_tseng/.config/opencode/context/core/standards/test-coverage.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /c/Users/tc_tseng/.config/opencode/context/
ELSE:
  READ from /c/Users/tc_tseng/.config/opencode/context/
  CACHE the file
```
