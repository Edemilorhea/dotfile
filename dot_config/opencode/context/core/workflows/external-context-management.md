...
- **Task Delegation**: `/c/Users/tc_tseng/.config/opencode/context/core/workflows/task-delegation-basics.md` — How to reference external context in sessions
- **Session Management**: `/c/Users/tc_tseng/.config/opencode/context/core/workflows/session-management.md` — Session lifecycle
