...
```bash
npx ts-node /c/Users/tc_tseng/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/c/Users/tc_tseng/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
