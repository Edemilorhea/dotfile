...
**Core Standards**:
- `/c/Users/tc_tseng/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/c/Users/tc_tseng/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/c/Users/tc_tseng/.config/opencode/context/core/standards/docs.md` → Documentation standards
- (example: `/c/Users/tc_tseng/.config/opencode/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `/c/Users/tc_tseng/.config/opencode/context/core/workflows/delegation.md`) → Delegation process
- (example: `/c/Users/tc_tseng/.config/opencode/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `/c/Users/tc_tseng/.config/opencode/context/core/workflows/review.md`) → Code review guidelines
