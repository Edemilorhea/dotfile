...
/c/Users/tc_tseng/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /c/Users/tc_tseng/.config/opencode/context/{category}
...
```bash
cat > /c/Users/tc_tseng/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/c/Users/tc_tseng/.config/opencode/context/{category}/
...
Loads: `/c/Users/tc_tseng/.config/opencode/context/ui/web/react-patterns.md`
