...
Tool Call Details:
  1. glob: {"pattern":"*.md","path":"/c/Users/tc_tseng/.config/opencode/context/core"}
```
...
prompts:
  - text: |
      List all markdown files in /c/Users/tc_tseng/.config/opencode/context/core/
```
...
prompts:
  - text: |
      Use the glob tool to find all markdown files in /c/Users/tc_tseng/.config/opencode/context/core/
      
      You MUST use the glob tool like this:
      glob(pattern="*.md", path="/c/Users/tc_tseng/.config/opencode/context/core")
