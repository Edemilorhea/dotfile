...
- Scope: `.`
- Summary: Added a dedicated marker and changelog for Atuin configuration.
- Important records:
  - The nearest ancestor marker owns future records; nested markers take precedence.
  - History databases, authentication state, and caches are not approved by this marker.
