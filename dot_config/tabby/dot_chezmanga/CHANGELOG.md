...
- Scope: `.`
- Summary: Added a dedicated marker and changelog for Tabby configuration.
- Important records:
...
- Portability: Existing ignore rules keep Windows-specific Tabby paths off other platforms.
